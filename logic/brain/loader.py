...
The active instance config is runtime/brain/blueprint.json.

To add a new brain blueprint:
1. Create logic/brain/blueprint/<name>-<YYYYMMDD>/blueprint.json
2. Implement any new backends in logic/brain/backends/
...
BACKEND_REGISTRY = {
    "flatfile": "logic.brain.backends.flatfile.FlatFileBrainBackend",
}
...
def load_base(root: Optional[Path] = None) -> Dict:
    """Load the shared base rules from logic/brain/blueprint/base.json."""
...
def _default_blueprint() -> Dict:
    ...
    return {
        ...
        "version": "1.0",
        "tiers": {
            "working": {"backend": "flatfile", "path": "runtime/brain/"},
            "knowledge": {"backend": "flatfile", "path": "runtime/experience/"},
