...
Filesystem layout:
    runtime/brain/.active               # Current session name (text file)
    runtime/brain/sessions/
        default/
...
Migration from flat layout:
    On first use, if runtime/brain/sessions/ doesn't exist, the current flat
...
class BrainSessionManager:
    ...
    def __init__(self, root: Path):
        self.root = Path(root)
        self.brain_root = self.root / "runtime" / "brain"
    ...
    def list_types(self) -> List[Dict]:
        """List all available brain blueprints from logic/brain/blueprint/."""
        from logic.brain.loader import list_blueprints
    ...
    def create_session(self, name: str, brain_type: Optional[str] = None, soul: Optional[str] = None) -> Path:
        ...
        if soul:
            ...
            default_soul = self.root / "runtime" / "experience" / "default" / "SOUL.md"
    ...
    def export_session(self, name: str, output_path: Optional[Path] = None) -> Path:
        ...
        Args:
            ...
            output_path: Output zip path. Defaults to runtime/brain/exports/<name>_<timestamp>.zip
