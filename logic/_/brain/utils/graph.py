...
def build_ecosystem_graph(root: Path) -> ActionGraph:
    ...
    # --- File nodes ---
    graph.add_node("file:git_manager", "file", "logic/_/git/manager.py",
    ...
    graph.add_node("file:brain_loader", "file", "logic/_/brain/loader.py",
    ...
    graph.add_node("file:procedural", "file", "logic/_/brain/utils/procedural.py",
