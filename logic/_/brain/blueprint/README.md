...
1. Create a directory: `logic/_/brain/blueprint/<name>-<YYYYMMDD>/`
...
5. If a new backend is needed, implement in `logic/_/brain/backends/`
...
- **Guidance**: bootstrap docs (`AGENT.md`)
