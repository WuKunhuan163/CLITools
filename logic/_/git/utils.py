...
def sync_dev_logic(project_root: Path, quiet=False, translation_func: Optional[Callable] = None):
    ...
    """
    from logic._.git.engine import get_current_branch, push_with_progress
    ...
    if start_branch == "dev":
        from logic._.git.engine import push_with_progress
...
def align_branches_logic(project_root: Path, quiet=False, translation_func: Optional[Callable] = None):
    ...
    """
    from logic._.git.engine import get_current_branch
