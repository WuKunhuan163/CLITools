# logic/_/translation - Agent Reference
...
3. Tool-specific: Tools can have `tool/X/logic/_/translation/zh.json`; overrides root for that tool's logic dir

## Gotchas

- English is default; no en.json needed for root
- `list_languages` discovers langs from `logic/_/translation/*.json` filenames
