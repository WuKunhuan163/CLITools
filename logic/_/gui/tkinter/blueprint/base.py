...
try:
    from logic._.gui.tkinter.style import get_label_style, get_button_style, get_status_style, get_gui_colors, get_secondary_label_style
...
class BaseGUIWindow:
    ...
    def __init__(self, title: str, timeout: int, internal_dir: str, tool_name: str = None, focus_interval: int = 90):
        ...
        from logic._.utils import find_project_root
