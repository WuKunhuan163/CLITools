...
class ButtonBarWindow(BaseGUIWindow):
    ...
    def setup_ui(self):
        from logic._.gui.tkinter.style import get_button_style, get_label_style
        ...
        try:
            from logic._.utils.accessibility.keyboard.monitor import _log
    ...
    def _check_keyboard_capture() -> bool:
        ...
        """
        try:
            from logic._.utils.accessibility.keyboard.monitor import is_available, check_accessibility_trusted, _log, _init_log
            _init_log()
            avail = is_available()
    ...
    def _start_global_key_listener(self):
        ...
        if not self._keyboard_available:
            ...
            return
        from logic._.utils.accessibility.keyboard.monitor import start_paste_enter_listener
    ...
    def _stop_global_key_listener(self):
        from logic._.utils.accessibility.keyboard.monitor import stop_listener
