...
Usage:
    from logic._.gui.serve.html_server import LocalHTMLServer
...
class LocalHTMLServer:
    ...
    def open_browser(self, auto_boot: bool = False):
        ...
        try:
            if auto_boot:
                from logic._.utils.chrome.session import auto_acquire_tab, CDP_PORT
                opened = auto_acquire_tab(url, port=CDP_PORT)
            else:
                from logic._.utils.chrome.session import open_tab, CDP_PORT
