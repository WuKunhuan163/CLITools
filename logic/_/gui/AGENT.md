# logic/_/gui - Agent Guide

> **Import convention**: Tools should import from `interface.gui` (the facade), not directly from `logic._.gui`. See `interface/AGENT.md`.
