...
from logic._.utils import get_display_width as get_visible_len, truncate_to_display_width, get_rtl_mode
...
class MultiLineManager:
    ...
    def update(self, worker_id: str, text: str, is_final: bool = False, callback: Optional[Callable] = None, truncate: Optional[bool] = None):
        ...
        if is_final:
            processed_text = " | ".join([line for line in text.splitlines() if line.strip()])
        else:
