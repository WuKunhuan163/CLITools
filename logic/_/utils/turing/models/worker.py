...
from logic._.utils.turing.utils import log_turing_error
from logic._.lang.utils import get_translation
from logic._.utils import get_logic_dir, find_project_root
...
class DynamicStatusBar:
    ...
    def _render(self):
        ...
        if self.total_count is not None:
            from logic._.utils import calculate_eta
            ...
            if self.baseline_completed > 0:
                ...
                if remote_count <= 0:
                    ...
                    from logic._.utils import format_seconds
                ...
                try:
                    ...
                    while futures:
                        ...
                        if timeout and time.time() - self.status_bar.last_progress_time > timeout:
                            ...
                            from logic._.utils.turing.logic import TuringError
