# logic/_/utils - Agent Reference

> **Import convention**: Tools should import from `interface.utils` (the facade), not directly from `logic._.utils`. See `interface/AGENT.md`.
