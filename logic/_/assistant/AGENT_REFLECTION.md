# Assistant — Agent Self-Reflection

## Purpose

This file is a **stable reflection guide** for agents working on Assistant. It prompts self-evaluation and identifies improvement opportunities. It is NOT a recording file — session discoveries go to `BRAIN log` / `SKILLS learn`, not here.
...
- **Discovery**: Did I read this module's `AGENT.md` and search for related skills before coding?
