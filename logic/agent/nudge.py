...
def should_nudge(text: str) -> bool:
    ...
    than a final answer.  Does NOT trigger on questions or conversational
    responses.
    """
    text_lower = text.lower()

    question_indicators = ["what file", "which file", "what do you want",
                           "would you like me to", "shall i", "do you want",
                           "can you clarify", "could you", "please specify",
    ...
    applied_indicators = ["i've created", "i've updated", "i've fixed",
                          ...
                          "i haven't", "i have not", "no changes"]
