# Serve — Agent Self-Reflection

## Purpose

This file is a **stable reflection guide** for agents working on Serve. It prompts self-evaluation and identifies improvement opportunities. It is NOT a recording file — session discoveries go to `BRAIN log` / `SKILLS learn`, not here.
