...
1. **Facade modules** — re-export commonly used core components so that
   ...
   into the internal package hierarchy:
       ...
       from interface.gui    import ButtonBarWindow, TutorialWindow
       from interface.config import get_color, get_setting
       from interface.lang   import get_translation
       from interface.tool   import ToolBase, ToolEngine
