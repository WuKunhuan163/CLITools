...
if __name__ == "__main__":
    ...
    def icloud_verify_handler(state):
        ...
        session_base = os.environ.get("GDS_LOGIN_SESSION_DIR")
        if session_base:
            cookie_dir = Path(session_base) / apple_id
        else:
            cookie_dir = project_root / "tool" / "iCloud.iCloudPD" / "data" / "session" / apple_id
