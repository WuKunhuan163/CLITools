#!/usr/bin/env python3
"""
GDS Large File Upload GUI: shows instructions for manual drag-and-drop upload.
...
def main():
    ...
    win = ButtonBarWindow(
        title="GDS Large File Upload",
        timeout=600,
        internal_dir=str(proj_root / "tool" / "GOOGLE.GDS" / "logic"),
        buttons=buttons,
