...
from interface.mcp import BrowserMCPConfig


def get_mcp_config():
    """Return the MCP configuration for GDS."""
    return MCPToolConfig(
        tool_name="GOOGLE.GDS",
...
def is_browser_ready():
    """Check if browser MCP is available for GDS operations."""
