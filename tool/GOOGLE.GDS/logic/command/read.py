#!/usr/bin/env python3
"""GDS read command: display remote file content with line numbers."""
import sys
...
Examples:
  GDS read ~/tmp/script.py           Display entire file with line numbers
  GDS read ~/tmp/script.py 10 20     Display lines 10-20
  GDS read --force config.json       Force re-read bypassing cache""")
