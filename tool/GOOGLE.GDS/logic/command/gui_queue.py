#!/usr/bin/env python3
"""
GDS GUI Queue Manager: ensures GUI interaction windows execute in FIFO order.

When multiple GDS commands need GUI windows (e.g., cd followed by echo >>),
...
class GUIQueue:
    """File-lock-based FIFO queue for GDS GUI windows."""
...
def get_gui_queue(project_root: Path) -> GUIQueue:
    """Get or create the global GDS GUI queue singleton."""
