#!/usr/bin/env python3
"""GDS linter command: lint remote files locally."""
import os
import sys
import json
import subprocess
...
Examples:
  GDS linter ~/tmp/script.py              Lint Python file
  GDS linter ~/config.json                Validate JSON
  GDS linter ~/run.sh                     Lint shell script
  GDS linter ~/app.js --language javascript   Override language""")
