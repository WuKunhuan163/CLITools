...
class TestDriveAPIAccess(unittest.TestCase):
    ...
    def test_02_ls_root(self):
        """GDS ls ~ should list files in the remote root."""
    ...
    def test_03_ls_long_format(self):
        """GDS ls -l ~ should show IDs and folder types."""
    ...
    def test_04_ls_invalid_path(self):
        """GDS ls with an invalid path should return non-zero and print bash-like error."""
    ...
    def test_05_cd_root(self):
        """GDS cd ~ should succeed silently (like bash cd)."""
