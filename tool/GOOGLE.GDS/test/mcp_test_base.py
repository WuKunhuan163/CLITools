"""
Shared base for MCP-enabled GDS tests.
...
def has_service_account():
    """Check if the GDS service account key is configured."""
...
class MCPTestCase(unittest.TestCase):
    ...
    _mcp_available = None
    gcs_bin = PROJECT_ROOT / "bin" / "GDS" / "GDS"
    ...
    def gcs(self, args, timeout=180, use_mcp=None, no_feedback=None):
        """Run a GDS command. Adds --mcp and --no-feedback flags when CDP is available.
        
        Args:
            args: List of command arguments (after GDS)
