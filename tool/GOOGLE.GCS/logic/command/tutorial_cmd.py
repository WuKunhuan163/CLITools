#!/usr/bin/env python3
"""GCS --setup-tutorial command: run the interactive setup wizard."""
import sys
...
def execute(tool, **kwargs):
    ...
    if res.get("status") == "success":
        ...
        print(f"{get_color('BOLD')}{get_color('GREEN')}{success_label}{get_color('RESET')} {_('success_setup_tutorial', 'GCS setup tutorial.')}")
        return 0
    else:
