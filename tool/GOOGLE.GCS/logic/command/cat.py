#!/usr/bin/env python3
"""GCS cat command: display content of a remote file."""
import sys
...
Examples:
  GCS cat ~/tmp/script.py             Display file content
  GCS cat @/config/settings.json      Display env config file
  GCS cat --force ~/data/output.txt   Force read bypassing cache""")
