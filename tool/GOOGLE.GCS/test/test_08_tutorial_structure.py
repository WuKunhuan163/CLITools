...
class TestTutorialStructure(unittest.TestCase):
    ...
    def test_01_tutorial_files_exist(self):
        ...
        tutorial_dir = project_root / "tool" / "GOOGLE.GCS" / "logic" / "tutorial" / "setup_guide"
    ...
    def test_02_tutorial_main_importable(self):
        ...
        tutorial_path = project_root / "tool" / "GOOGLE.GCS" / "logic" / "tutorial" / "setup_guide" / "main.py"
    ...
    def test_03_cache_directory_structure(self):
        ...
        cache_base = project_root / "tool" / "GOOGLE.GCS" / "data" / "tutorial" / "cache"
