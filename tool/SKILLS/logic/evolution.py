...
BRAIN_DIR = Path(__file__).resolve().parent.parent.parent.parent / "data" / "_" / "runtime" / "_" / "eco" / "experience"
...
def introspect(max_transcripts=5):
    ...
    tool_names_pattern = re.compile(
        r'\b(WHATSAPP|GMAIL|GOOGLE\.GDS|GOOGLE\.GC|GOOGLE\.GD|GOOGLE\.CDMCP|GOOGLE\.GS|'
