"""Gemini 2.5 Flash via Google AI Studio (OpenAI-compatible endpoint).

Endpoint: https://generativelanguage.googleapis.com/v1beta/openai/chat/completions
Model:    gemini-2.5-flash
Free tier available (rate-limited). Paid: $0.3/M in, $2.5/M out.
"""
...
class GoogleGemini25FlashProvider(OpenAICompatProvider):
