...
from ...formatter import format_segments_with_color_merging, get_span_style, strip_non_standard_chars
...
class Settlement:
    ...
    def _format_item(self, item: Dict[str, Any]) -> Dict[str, Any]:
        # Generate Markdown formatting using existing helpers
        ...
        if block_type in ["paragraph", "heading"]:
            # Special case for bold starts in paragraphs (subheadings)
