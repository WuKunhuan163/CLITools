...
class ImageIdentifier:
    ...
    def identify(self, images: List[Dict[str, Any]], tokens: List[Dict[str, Any]]) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
        ...
        for it in images:
            ...
            for c in clusters:
                ...
                if dist_x < 5 and dist_y < 5:
                    ...
                    break
            if not merged:
                clusters.append({"bbox": bbox, "items": [it], "absorbed_text": []})
        ...
        for i, token in enumerate(tokens):
            ...
            is_absorbed = False
            if min_dist_to_img < 3: is_absorbed = True
            elif min_dist_to_img < 15 and min_dist_to_img < min_dist_to_text / 3: is_absorbed = True
