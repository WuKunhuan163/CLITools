...
| Tier | Purpose | Path |
|------|---------|------|
| **working** | Hot state (tasks, context, activity) | `runtime/_/eco/brain/` |
| **knowledge** | Lessons, skills, institutional memory | `runtime/_/eco/experience/` |
| **episodic** | Agent personality, long-term memory | `runtime/_/eco/experience/{brain_type}/` |
...
- `reflection` → `skills/_/meta-agent/SKILL.md` (self-improvement protocol)
