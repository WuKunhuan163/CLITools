...
```json
"command": "python3 hooks/instance/AI-IDE/Cursor/brain_remind.py"
```
...
echo '{"workspace_roots": ["/Applications/AITerminalTools"], "conversation_id": "test", "tool_name": "Read"}' | python3 hooks/instance/AI-IDE/Cursor/brain_remind.py
```
