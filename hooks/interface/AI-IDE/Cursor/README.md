...
Defines all available lifecycle hook events in Cursor IDE's agent system. Instances at `hooks/instance/AI-IDE/Cursor/` implement specific behaviors for these events.
