...
class GoogleDriveShell:
    ...
    def execute_background_command(self, shell_cmd, command_identifier=None):
        ...
        try:
            ...
            cmd_parts.append(f"echo '        \"end_time\": datetime.now().isoformat()' >> {tmp_path}/{script_file}")
            cmd_parts.append(f"echo '    }}' >> {tmp_path}/{script_file}")
            cmd_parts.append(f"echo '}}' >> {tmp_path}/{script_file}")
    ...
    def execute_shell_command(self, shell_cmd, command_identifier=None, command_wrapper=None):
        ...
        try:
            ...
            print (capture_and_report_error("Shell command execution", e, {
                "command": shell_cmd,
