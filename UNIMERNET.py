...
class UnimerNetProcessor:
    ...
    def init_unimernet_model(self):
        """Initialize UnimerNet model using simplified interface"""
        if not lazy_import_unimernet():
