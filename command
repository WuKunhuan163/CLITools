...
cd "/content/drive/MyDrive/REMOTE_ROOT" && {
    ...
    # 执行命令并捕获输出
    OUTPUT_FILE="/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_stdout_1759132895_7fbdcd7f"
    ERROR_FILE="/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_stderr_1759132895_7fbdcd7f"
    EXITCODE_FILE="/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_exitcode_1759132895_7fbdcd7f"
    
    # 直接执行命令，捕获输出和错误
    set +e  # 允许命令失败
    echo 'Normal command test' > "$OUTPUT_FILE" 2> "$ERROR_FILE"
    EXIT_CODE=$?
    ...
    PYTHON_SCRIPT="/content/drive/MyDrive/REMOTE_ROOT/tmp/json_generator_1759132895_7fbdcd7f.py"
...
# 文件路径
stdout_file = "/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_stdout_1759132895_7fbdcd7f"
stderr_file = "/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_stderr_1759132895_7fbdcd7f"
exitcode_file = "/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_exitcode_1759132895_7fbdcd7f"
...
SCRIPT_END
    python3 "$PYTHON_SCRIPT" > "/content/drive/MyDrive/REMOTE_ROOT/tmp/cmd_1759132895_7fbdcd7f.json"
    rm -f "$PYTHON_SCRIPT"
