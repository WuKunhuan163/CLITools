...
class NetworkTester:
    ...
    def test_network_speed(self):
        ...
        try:
            ...
            # Test latency (ping)
            latency_ms = self.test_latency()
            
            # Test download speed
            download_speed_mbps = self.test_download_speed()
            
            # Test upload speed (simplified)
            upload_speed_mbps = self.test_upload_speed()
            ...
            # Save results
            self.save_network_data(results)
            ...
            self.save_network_data(error_result)
    ...
    def test_latency(self):
        ...
        try:
            ...
            return self.http_latency_test()
            
        except Exception:
            return self.http_latency_test()
    
    def http_latency_test(self):
