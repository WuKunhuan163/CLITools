...
def test_run_environment_detection():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_run_environment_detection skipped - EXPORT module not available")
        return
...
def test_json_output_creation():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_json_output_creation skipped - EXPORT module not available")
        return
...
def test_variable_name_validation():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_variable_name_validation skipped - EXPORT module not available")
        return
...
def test_get_shell_config_files():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_get_shell_config_files skipped - EXPORT module not available")
        return
...
def test_remove_existing_export():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_remove_existing_export skipped - EXPORT module not available")
        return
...
def test_add_export_statement():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_add_export_statement skipped - EXPORT module not available")
        return
...
def test_help_function():
    ...
    if not EXPORT_AVAILABLE:
        print("⏭️  test_help_function skipped - EXPORT module not available")
        return
...
def test_run_show_compatibility():
    ...
    if not run_py.exists():
        print("⏭️  test_run_show_compatibility skipped - RUN.py not found")
        return
...
def run_all_unit_tests():
    """Run all unit tests"""
    print("🧪 Running all EXPORT unit tests...")
    passed = 0
    failed = 0
...
if __name__ == '__main__':
    ...
    if args.integration_only or args.export_only:
        print("🧪 Running EXPORT integration test only...")
        success = run_integration_tests(['test_09_export'])
        
    elif args.with_google_drive:
        print("🧪 Running EXPORT and GOOGLE_DRIVE integration tests...")
