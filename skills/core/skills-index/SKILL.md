...
| `tool-dependency-declaration` | Declaring tool dependencies in `tool.json` |
| `unified-gui-development` | Synchronized HTML GUI + CLI GUI feature development |
...
| `development-iteration-protocol` | Escalating test requirements on repeated fix failures |
...
Planning, ordering, and composing multi-tool workflows.

| Skill | Purpose |
|-------|---------|
| `task-orchestration` | Decompose requests, execution order, multi-tool composition |
| `recipes` | Concrete end-to-end workflow examples |
...
| `agent-onboarding` | Bootstrap protocol, session phases, self-iteration loop |
...
| Old Skill | Merged Into | Section |
|-----------|-------------|---------|
| `task-execution-order` | `task-orchestration` | "Execution Order" |
