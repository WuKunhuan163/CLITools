...
🌐 Clawdis**Bins**node, npmFilesCompareVersions
## SKILL.md
...
- Skill issues: Open an issue at [https://github.com/TheSethRose/Agent-Browser-CLI](https://github.com/TheSethRose/Agent-Browser-CLI)
- agent-browser CLI issues: Open an issue at [https://github.com/vercel-labs/agent-browser](https://github.com/vercel-labs/agent-browser)

### Files
2 totalCONTRIBUTING.md1.6 KBSKILL.md10.0 KBSelect a fileSelect a file to preview.
## Comments
Loading comments…