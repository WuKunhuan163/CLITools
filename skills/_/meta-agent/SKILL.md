...
2. **Lesson**: The error is recorded with context — what happened, why, and how it was resolved. Stored in `data/_/runtime/_/eco/experience/lessons.jsonl`.
...
The brain system (`data/_/runtime/_/eco/brain/`) is designed to be pluggable. Everything a meta-agent learns is stored in files that can be attached to any other assistant. This means:
