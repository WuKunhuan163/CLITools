...
2. Are there 2+ independent tasks that benefit from parallelism? -> Consider subagents with `model: "fast"`.
3. Is the user explicitly asking for subagent delegation? -> Use subagents with `model: "fast"`.
4. Otherwise -> Do it yourself.
